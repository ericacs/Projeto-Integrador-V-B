...
void loop() {
  ...
  Serial.print(temperatureC);   // Leitura do TMP36
  Serial.print("\tUmidade (Potenciometro): ");
  Serial.print(umidadePercentual);      // Leitura do Potenciometro (Umidade) em percentual
  Serial.print("\tLuminosidade (Potenciometro): ");
  Serial.println(luminosidadePercentual); // Leitura do Potenciometro (Luminosidade) em percentual
  ...
  // Atraso de 5,5 segundo antes da próxima leitura
  delay(5500);
}
